...
static const bool InsideLeftPlane(const float _X, const float _W)
{
	return _X / _W > -1.0f;
}

static const bool InsideRightPlane(const float _X, const float _W)
{
	return _X / _W < 1.0f;
}

static const bool InsideBottomPlane(const float _Y, const float _W)
{
	return _Y / _W > -1.0f;
}

static const bool InsideTopPlane(const float _Y, const float _W)
{
	return _Y / _W < 1.0f;
}
...
static const float GetTLeftPlane(const float _XOut, const float _WOut, const float _XIn, const float _WIn)
{
	return 1.0f;
}

static const float GetTRightPlane(const float _XOut, const float _WOut, const float _XIn, const float _WIn)
{
	return 1.0f;
}

static const float GetTBottomPlane(const float _YOut, const float _WOut, const float _YIn, const float _WIn)
{
	return 1.0f;
}

static const float GetTTopPlane(const float _YOut, const float _WOut, const float _YIn, const float _WIn)
{
	return 1.0f;
}
...
const bool Rasterizer::Context::RenderMesh(const void* _VBO, const size_t _VBOSize, const size_t _VBOStride, const size_t* _IBO, const size_t _IBOBegin, const size_t _IBOEnd, const void* _Uniforms, const size_t _LerpersCountVertToGeom, const size_t _LerpersCountGeomToFrag, const VertexShaderFnc _VertexShader, const GeometryShaderFnc _GeometryShader, const FragmentShaderFnc _FragmentShader, void* _FrameBuffer) const
{
	...
	for (size_t _IndexTriangle = 0; _IndexTriangle < _GeometryShaderOutputs.size(); _IndexTriangle++)
	{
		bool _AInside = InsideLeftPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		bool _BInside = InsideLeftPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
		bool _CInside = InsideLeftPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
		...
		case 1:
		{
			...
			float _TB = GetTLeftPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
			float _TC = GetTLeftPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		...
		case 2:
		{
			...
			float _TB = GetTLeftPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
			float _TC = GetTLeftPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
	...
	for (size_t _IndexTriangle = 0; _IndexTriangle < _GeometryShaderOutputs.size(); _IndexTriangle++)
	{
		bool _AInside = InsideRightPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		bool _BInside = InsideRightPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
		bool _CInside = InsideRightPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
		...
		case 1:
		{
			...
			float _TB = GetTRightPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
			float _TC = GetTRightPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		...
		case 2:
		{
			...
			float _TB = GetTRightPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].B.Position.x, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
			float _TC = GetTRightPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.x, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].C.Position.x, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
	...
	for (size_t _IndexTriangle = 0; _IndexTriangle < _GeometryShaderOutputs.size(); _IndexTriangle++)
	{
		bool _AInside = InsideBottomPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		bool _BInside = InsideBottomPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
		bool _CInside = InsideBottomPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
		...
		case 1:
		{
			...
			float _TB = GetTBottomPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
			float _TC = GetTBottomPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		...
		case 2:
		{
			...
			float _TB = GetTBottomPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
			float _TC = GetTBottomPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
	...
	for (size_t _IndexTriangle = 0; _IndexTriangle < _GeometryShaderOutputs.size(); _IndexTriangle++)
	{
		bool _AInside = InsideTopPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		bool _BInside = InsideTopPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
		bool _CInside = InsideTopPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
		...
		case 1:
		{
			...
			float _TB = GetTTopPlane(_GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
			float _TC = GetTTopPlane(_GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w, _GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w);
		...
		case 2:
		{
			...
			float _TB = GetTTopPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].B.Position.y, _GeometryShaderOutputs[_IndexTriangle].B.Position.w);
			float _TC = GetTTopPlane(_GeometryShaderOutputs[_IndexTriangle].A.Position.y, _GeometryShaderOutputs[_IndexTriangle].A.Position.w, _GeometryShaderOutputs[_IndexTriangle].C.Position.y, _GeometryShaderOutputs[_IndexTriangle].C.Position.w);
