...
template <typename T> std::ostream& operator<< (std::ostream& _OutStream, const BSR::Vector<T>& _Vec)
{
...
template <typename T> std::istream& operator>> (std::istream& _InStream, BSR::Vector<T>& _Vec)
{
	size_t _Size = 0;
...
template <typename T> std::wostream& operator<< (std::wostream& _OutStream, const BSR::Vector<T>& _Vec)
{
	_OutStream << _Vec.GetSize() << '\n';
...
template <typename T> std::wistream& operator>> (std::wistream& _InStream, BSR::Vector<T>& _Vec)
{
	size_t _Size = 0;
