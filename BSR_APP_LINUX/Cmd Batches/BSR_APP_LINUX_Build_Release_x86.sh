...
export CPP_FLAGS="-c -std=gnu++17 -I\"./BSR/Headers/\" -m32"
export LINK_FLAGS="-L\"./Binaries/BSR/Release/x86/\""
...
g++ $LINK_FLAGS -o "./Binaries/BSR_APP_LINUX/Release/x86/BSR_APP_LINUX" "./Objects/BSR_APP_LINUX/Release/x86/BSR_APP_LINUX_EntryPoint.o"
