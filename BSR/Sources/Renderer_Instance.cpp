...
BSR::Renderer::Instance::Instance() : TargetFrameBuffer(), TargetCamera(), TargetExposure(1.0f), TargetFogStart(TargetCamera.FarPlane), TargetFogEnd(TargetCamera.FarPlane + 1.0f), TargetEnvironment(nullptr), TargetIradiance(nullptr), TargetMeshes(), TargetMaterials(), TargetTransforms(), TargetLights()
{
...
bool BSR::Renderer::Instance::StartScene(FrameBuffer& _TargetFrameBuffer, const Camera& _TargetCamera, const float _TargetExposure, const float _TargetFogStart, const float _TargetFogEnd, const Rasterizer::Texture_Float_RGB& _TargetEnvironment, const Rasterizer::Texture_Float_RGB& _TargetIradiance)
{
	TargetMeshes.clear();
