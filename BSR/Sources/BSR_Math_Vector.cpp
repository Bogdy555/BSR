...
const BSR::Math::Vec2f BSR::Math::Vec2f::operator+ (const float _Value) const
{
	return Vec2f(x + _Value, y + _Value);
}

const BSR::Math::Vec2f& BSR::Math::Vec2f::operator+= (const float _Value)
{
	x += _Value;
	y += _Value;
...
BSR::Math::Vec2f& BSR::Math::Vec2f::operator= (const Vec2f& _Other)
{
	x = _Other.x;
	y = _Other.y;
...
BSR::Math::Vec2f& BSR::Math::Vec2f::operator= (Vec2f&& _Other) noexcept
{
	x = _Other.x;
	y = _Other.y;
...
const BSR::Math::Vec3f BSR::Math::Vec3f::operator+ (const float _Value) const
{
	return Vec3f(x + _Value, y + _Value, z + _Value);
}

const BSR::Math::Vec3f& BSR::Math::Vec3f::operator+= (const float _Value)
{
	x += _Value;
	y += _Value;
	z += _Value;
...
BSR::Math::Vec3f& BSR::Math::Vec3f::operator= (const Vec3f& _Other)
{
	x = _Other.x;
	y = _Other.y;
	z = _Other.z;
...
BSR::Math::Vec3f& BSR::Math::Vec3f::operator= (Vec3f&& _Other) noexcept
{
	x = _Other.x;
	y = _Other.y;
	z = _Other.z;
...
const BSR::Math::Vec4f BSR::Math::Vec4f::operator+ (const float _Value) const
{
	return Vec4f(x + _Value, y + _Value, z + _Value, w + _Value);
}

const BSR::Math::Vec4f& BSR::Math::Vec4f::operator+= (const float _Value)
{
	x += _Value;
	y += _Value;
	z += _Value;
...
BSR::Math::Vec4f& BSR::Math::Vec4f::operator= (const Vec4f& _Other)
{
	x = _Other.x;
	y = _Other.y;
	z = _Other.z;
...
BSR::Math::Vec4f& BSR::Math::Vec4f::operator= (Vec4f&& _Other) noexcept
{
	x = _Other.x;
	y = _Other.y;
	z = _Other.z;
