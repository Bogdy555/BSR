...
const BSR::Math::Mat2f BSR::Math::Mat2f::operator+ (const float _Value) const
{
	Mat2f _Matrix(*this);
...
const BSR::Math::Mat2f& BSR::Math::Mat2f::operator+= (const float _Value)
{
...
BSR::Math::Mat2f& BSR::Math::Mat2f::operator= (const Mat2f& _Other)
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1];
...
BSR::Math::Mat2f& BSR::Math::Mat2f::operator= (Mat2f&& _Other) noexcept
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1];
...
const BSR::Math::Mat3f BSR::Math::Mat3f::operator+ (const float _Value) const
{
	Mat3f _Matrix(*this);
...
const BSR::Math::Mat3f& BSR::Math::Mat3f::operator+= (const float _Value)
{
...
BSR::Math::Mat3f& BSR::Math::Mat3f::operator= (const Mat3f& _Other)
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1]; Matrix[0][2] = _Other[0][2];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1]; Matrix[1][2] = _Other[1][2];
	Matrix[2][0] = _Other[2][0]; Matrix[2][1] = _Other[2][1]; Matrix[2][2] = _Other[2][2];
...
BSR::Math::Mat3f& BSR::Math::Mat3f::operator= (Mat3f&& _Other) noexcept
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1]; Matrix[0][2] = _Other[0][2];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1]; Matrix[1][2] = _Other[1][2];
	Matrix[2][0] = _Other[2][0]; Matrix[2][1] = _Other[2][1]; Matrix[2][2] = _Other[2][2];
...
const BSR::Math::Mat4f BSR::Math::Mat4f::operator+ (const float _Value) const
{
	Mat4f _Matrix(*this);
...
const BSR::Math::Mat4f& BSR::Math::Mat4f::operator+= (const float _Value)
{
...
BSR::Math::Mat4f& BSR::Math::Mat4f::operator= (const Mat4f& _Other)
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1]; Matrix[0][2] = _Other[0][2]; Matrix[0][3] = _Other[0][3];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1]; Matrix[1][2] = _Other[1][2]; Matrix[1][3] = _Other[1][3];
	Matrix[2][0] = _Other[2][0]; Matrix[2][1] = _Other[2][1]; Matrix[2][2] = _Other[2][2]; Matrix[2][3] = _Other[2][3];
...
BSR::Math::Mat4f& BSR::Math::Mat4f::operator= (Mat4f&& _Other) noexcept
{
	Matrix[0][0] = _Other[0][0]; Matrix[0][1] = _Other[0][1]; Matrix[0][2] = _Other[0][2]; Matrix[0][3] = _Other[0][3];
	Matrix[1][0] = _Other[1][0]; Matrix[1][1] = _Other[1][1]; Matrix[1][2] = _Other[1][2]; Matrix[1][3] = _Other[1][3];
	Matrix[2][0] = _Other[2][0]; Matrix[2][1] = _Other[2][1]; Matrix[2][2] = _Other[2][2]; Matrix[2][3] = _Other[2][3];
