...
ar rcs "./Binaries/BSR/Release/x86/libBSR.a" "./Objects/BSR/Release/x86/BSR_Image.o" "./Objects/BSR/Release/x86/BSR_Math.o" "./Objects/BSR/Release/x86/BSR_Math_Matrix.o" "./Objects/BSR/Release/x86/BSR_Math_Vector.o" "./Objects/BSR/Release/x86/BSR_Rasterizer.o" "./Objects/BSR/Release/x86/BSR_Renderer.o"
