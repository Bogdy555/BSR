...
namespace BSR
{
	...
	namespace Math
	{
		...
		public:
			...
			const Vec2f operator+ (const float _Value) const;
			const Vec2f& operator+= (const float _Value);
		...
		public:
			...
			const Vec3f operator+ (const float _Value) const;
			const Vec3f& operator+= (const float _Value);
		...
		public:
			...
			const Vec4f operator+ (const float _Value) const;
			const Vec4f& operator+= (const float _Value);
		...
		public:
			...
			const Mat2f operator+ (const float _Value) const;
			const Mat2f& operator+= (const float _Value);
			...
			Mat2f& operator= (const Mat2f& _Other);
			Mat2f& operator= (Mat2f&& _Other) noexcept;
		...
		public:
			...
			const Mat3f operator+ (const float _Value) const;
			const Mat3f& operator+= (const float _Value);
			...
			Mat3f& operator= (const Mat3f& _Other);
			Mat3f& operator= (Mat3f&& _Other) noexcept;
		...
		public:
			...
			const Mat4f operator+ (const float _Value) const;
			const Mat4f& operator+= (const float _Value);
			...
			Mat4f& operator= (const Mat4f& _Other);
			Mat4f& operator= (Mat4f&& _Other) noexcept;
